...
function IndexPage(props: { data: any }) {
  const { data } = useQuery({
    queryFn: fetchData,
    queryKey: ["data"],
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={data.subline} />
        <link
      ...
      >
          ...
          <div className="flex flex-row  pt-16 lg:justify-between">
            <div className="relative flex w-full flex-col px-4 lg:w-2/3 lg:px-8 items-center">
              ...
              <motion.p
                ...
                animate={{
                  opacity: 1,
                  transition: { delay: 0.2, duration: 0.71 },
                }}
              ...
              <div className="mb-8 mt-10 flex flex-col items-center lg:flex-row">
                <motion.a
                  ...
                  animate={{
                    ...
                    transition: { delay: 0.5, duration: 0.71 },
                  }}
        ...
        >
          <g id="Ebene_2" data-name="Ebene 2" transform="translate(0 -0.012)">
        ...
        <section id="download" className="relative lg:mt-24">
          ...
          >
            <div className="container mx-auto flex max-w-6xl flex-col ">
              ...
              <motion.div
                className="mt-8 flex flex-col  px-8 lg:flex-row xl:px-0"
                initial={{ opacity: 0 }}
                whileInView={{
                  opacity: 1,
                  transition: { delay: 0.2, duration: 0.71 },
