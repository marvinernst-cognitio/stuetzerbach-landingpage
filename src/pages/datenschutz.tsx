...
const fetchData = async () => {
  const url = `https://stuetzerbach.cognitio.de/api/collections/get/Page?token=6ccda160ab7f2a091ef159761bfc1b&filter[title_slug]=datenschutz`;
...
export default function Datenschutz(props) {
  ...
  const { data } = useQuery("datenschutz", fetchData, {
